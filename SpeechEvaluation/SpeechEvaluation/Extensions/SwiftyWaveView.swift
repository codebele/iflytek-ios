...
open class SwiftyWaveView: UIView {
    ...
    @IBInspectable
    public var speed: CGFloat = 0.05//0.1
    @IBInspectable
    public var amplitude: CGFloat = 0.4//0.5
    @IBInspectable
    public var frequency: Int = 3//6
    @IBInspectable
    ...
    fileprivate let waves = [Wave(att: 1, lineWidth: 1.5, opacity: 1.0),
                             ...
                             Wave(att: 4, lineWidth: 1.0, opacity: 0.2),
                             Wave(att: 4, lineWidth: 1.0, opacity: 0.1)
                            ]
    ...
    public func loadWaveView() {
           animating = false
           animatingStart = false
           animatingStop = true
           currentAmplitude = 0.5 + 0.02
   ...
   public func stop() {
    ...
    public func update(_ level: CGFloat) {
        self.amplitude = fmax(level, idleAmplitude)
